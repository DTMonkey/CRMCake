...
class ProspectsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'society' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'title' => ['type' => 'string', 'length' => 25, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'other_sector' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'effective' => ['type' => 'string', 'length' => 25, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'secondary_email' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'pobox' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_indexes' => [
            'fk_prospect_user' => ['type' => 'index', 'columns' => ['user_id'], 'length' => []],
            'fk_prospect_source_prospect' => ['type' => 'index', 'columns' => ['source_prospect_id'], 'length' => []],
            'fk_prospect_status' => ['type' => 'index', 'columns' => ['statut_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_prospect_source_prospect' => ['type' => 'foreign', 'columns' => ['source_prospect_id'], 'references' => ['source_prospects', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'fk_prospect_status' => ['type' => 'foreign', 'columns' => ['statut_id'], 'references' => ['status', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'fk_prospect_user' => ['type' => 'foreign', 'columns' => ['user_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'phone' => 1,
                'society' => 'Lorem ipsum dolor sit amet',
                'mobile' => 1,
                ...
                'other_sector' => 'Lorem ipsum dolor sit amet',
                'effective' => 'Lorem ipsum dolor sit a',
                'secondary_email' => 'Lorem ipsum dolor sit amet',
                'pobox' => 'Lorem ipsum dolor sit amet',
                'wilaya' => 'Lorem ipsum dolor sit a',
                'description' => 'Lorem ipsum dolor sit amet',
                'comments' => 'Lorem ipsum dolor sit amet',
                'created' => '2018-05-16 14:53:19',
                'modified' => '2018-05-16 14:53:19',
                'user_id' => 1,
